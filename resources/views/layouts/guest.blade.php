                        ...
                        @auth
                          ...
                          <li style="	margin-top: 0;margin-left: 25px;">
                            <ul class="rd-navbar-nav">
                              <li class="rd-nav-item" style="padding: 10px; color:black"><a class="rd-nav-link" href="#" style="margin: 0px;font-size: 13px; color:black; background-color: white">Mi Cuenta (ADMIN)</a>
