        ...
        <section class="section section-sm bg-default" style="padding: 60px 0px 60px 0px">
            <div class="container" style="max-width: 968px">
                <h3 class="oh-desktop"><span class="d-inline-block wow slideInDown">Psicología:¿Que hay en tú despensa?</span></h3>
                                ...
                                <div class="unit-body">
                                    <div class="product-big-body">
                                        ...
                                        <p style="text-align: justify;">En este caso, el visitante inesperado es la Diabetes Tipo 1 que trae consigo cambio, 
                                            ...
                                            <p style="text-align: justify;">Además obliga a la familia a familiarizarse con endocrinología, hospital, insulina, 
                                            hipoglicemia etc.</p>
                                    </div>
                                </div>
                                <div class="unit-left"><a class="product-big-figure" href="#"><img
                                ...
                                <div class="unit-body">
                                    <div class="product-big-body">
                                        ...
                                        <p style="text-align: justify;">La misma metodología narrativa, sugiere que la familia busque fortalezas para manejar la enfermedad y 
                                            ...
                                            <p style="text-align: justify;">Ahí vamos a encontrar algunas cosas que nos van ayudar a sobrellevar la Diabetes Tipo 1 como: 
                                                la familia, el humor, el amor, las amistades, etc.</p>
                                    </div>
                                </div>
                                <div class="unit-left"><a class="product-big-figure" href="#"><img
                                ...
                                <div class="unit-body">
                                    <div class="product-big-body">
                                        <p style="text-align: justify;">Sin embargo, pasa un tiempo y llega otro “visitante inesperado” llamado Coronavirus. 
                                            Éste nos vuelve a desestabilizar y trae consigo conceptos como contagio, distanciamiento social, 
                            ...
                            <div class="unit flex-column flex-md-row align-items-md-stretch">
                                ...
                                <div class="unit-body">
                                    <div class="product-big-body">
                                        ...
                                        <p style="text-align: justify;">Cuando abrimos nuestra despensa, nos damos cuenta que la Diabetes Tipo 1 nos ha proporcionado muchas 
                                         ...
                                         <p style="text-align: justify;">Todos estos podemos usar para hacerle frente al Coronavirus y prepararle algo rico de comer con los mismos ingredientes. 
                                            Probablemente desarrollemos nuevas fortalezas a raíz de la pandemia para enfrentar otros desafíos a lo largo de nuestras vidas.</p>
                    ...
                    <div class="col-sm-12 col-md-12 wow fadeInRight">
                        ...
                        <article class="product-big">
                            <div class="unit flex-column flex-md-row align-items-md-stretch">
                                ...
                                <div class="unit-body">
                                    <div class="product-big-body">
                                        <p style="text-align: justify;">A nadie le gusta las crisis, pero afortunadamente ellas nos enseñan bastante y podemos usar lo que nos 
